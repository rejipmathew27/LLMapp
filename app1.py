# -*- coding: utf-8 -*-
"""streamlit_app.py (API Key Input in App)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xrSWrmvqmzXQDLA2ZKsOGag-F09UDy_N
"""

import streamlit as st
import os
import tempfile
from chatbot_core import load_documents, build_qa_chain # Import updated functions
import logging
...
st.title("💬 Chat with your Documents (PDF, XPT, SAS7BDAT) using OpenAI")
...
with st.sidebar:
    ...
    # Get OpenAI API key from user input - RE-ADDED
    ...
    uploaded_files = st.file_uploader(
        "Choose PDF, XPT, or SAS7BDAT files",
        accept_multiple_files=True,
        type=["pdf", "xpt", "sas7bdat"]
    )
    ...
    if process_button and uploaded_files and st.session_state.openai_api_key:
        ...
        with st.spinner(f"Processing {len(uploaded_files)} files with {openai_model}..."):
            try:
...
# --- Main Chat Interface (Mostly same as before) ---
